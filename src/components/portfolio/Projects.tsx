...
const projects = [
  {
    ...
    desc: "글래스모피즘과 부드러운 모션을 결합한 크리에이터용 포트폴리오 랜딩페이지 컨셉.",
        ...
        <div className="space-y-6">
          {projects.map((p, i) => (
            <Reveal key={p.num} delay={i * 0.1}>
              <div className="glass-strong group p-6 md:p-8 hover:border-white/25 transition-all duration-500 relative overflow-hidden">
                <div className="grid md:grid-cols-12 gap-8 items-center">
                  ...
                  <div className="md:col-span-5 relative aspect-[4/3] rounded-2xl overflow-hidden"
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="glass-strong w-3/4 aspect-video group-hover:scale-105 transition-transform duration-700 p-3">
                  ...
                  <div className="md:col-span-7">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      ...
                      <div className="shrink-0 w-10 h-10 rounded-full glass flex items-center justify-center group-hover:rotate-45 transition-transform duration-500">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {p.tags.map((t) => (
                        <span key={t} className="text-[11px] px-3 py-1 rounded-full glass text-white/70">#{t}</span>
                      ))}
                    </div>
                  </div>
                </div>
